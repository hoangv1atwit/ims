<?php
	...
	// Include connection for order queries
							...
							<div class="section_content">
								<div class="poListContainers">
									...
									<div class="poList" id="container-<?= $batch_id ?>">
										<p>Batch #: <?= htmlspecialchars($batch_id) ?> </p>
										<table>
											<thead>
												<tr>
													<th>#</th>
											...
											<tbody>
												...
												<tr>
													...
													<td class="po_qty_supplier"><?= htmlspecialchars($batch_po['requested_by']) ?></td>
												</tr>	
												<?php } ?>										
											</tbody>
										</table>
