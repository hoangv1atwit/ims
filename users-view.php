                                                                        ...
                                                                        <table>
                                                                                ...
                                                                                <tbody>
                                                                                        <?php foreach($users as $index => $user_item){ ?>
                                                                                                <tr>
                                                                                                        <td><?= $index + 1 ?></td>
                                                                                                        <td class="firstName"><?= htmlspecialchars($user_item['first_name']) ?></td>
                                                                                                        <td class="lastName"><?= htmlspecialchars($user_item['last_name']) ?></td>
                                                                                                        <td class="email"><?= htmlspecialchars($user_item['email']) ?></td>
                                                                                                        <td><?= date('M d,Y @ h:i:s A', strtotime($user_item['created_at'])) ?></td>
                                                                                                        <td><?= date('M d,Y @ h:i:s A', strtotime($user_item['updated_at'])) ?></td>
                                                                                                        <td data-no-translate="true">
                                                                                                                <a href="" 
                                                                                                                        class="<?= in_array('user_edit', $user_permission) ? 'updateUser' : 'accessDeniedErr' ?>" 
                                                                                                                        data-userid="<?= $user_item['id'] ?>" data-no-translate="true"> <i class="fa fa-pencil"></i> <span data-translatable="true">Edit</span></a> |
                                                                                                                <a href="" 
                                                                                                                        class="<?= in_array('user_delete', $user_permission) ? 'deleteUser' : 'accessDeniedErr' ?>" 
                                                                                                                        data-userid="<?= $user_item['id'] ?>" data-fname="<?= htmlspecialchars($user_item['first_name']) ?>" data-lname="<?= htmlspecialchars($user_item['last_name']) ?>" data-no-translate="true"> <i class="fa fa-trash"></i> <span data-translatable="true">Delete</span></a>
                                                                                                                <input type="hidden" id="cur_permission_<?= $user_item['id'] ?>" value="<?= htmlspecialchars($user_item['permissions']) ?>">
                                                                                                        </td>
                                                                                                </tr>
                                                                                        <?php } ?>
                                                                                </tbody>
                                                                ...
                                                                $.ajax({
                                                                        ...
                                                                        success: function(data){
                                                                                message = data.success ? 
                                                                                                fullName + ' successfully deleted!' : data.message || 'Error processing your request!';
