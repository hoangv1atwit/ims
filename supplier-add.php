                                        ...
                                        <div class="row">
                                                <div class="column column-12">
                                                        ...
                                                        <div id="userAddFormContainer">                                         
                                                                <form action="database/add-supplier-direct.php" method="POST" class="appForm" enctype="multipart/form-data">
                                                                        ...
                                                                        <div class="appFormInputContainer">
                                                                                ...
                                                                                <input type="text" class="appFormInput" placeholder="Enter supplier location..." id="supplier_location" name="supplier_location" required>
                                                                        </div>
                                                                        <div class="appFormInputContainer">
                                                                                <label for="email">Email</label>
                                                                                <input type="email" class="appFormInput" placeholder="Enter supplier email..." id="email" name="email" required>
                                                                        </div>
