<?php
        ...
        // Include connection for additional queries
                                                                                                ...
                                                                                                <tr>
                                                                                                        ...
                                                                                                        <td>
                                                                                                                <?php
                                                                                                                        ...
                                                                                                                        $created_by_name = $row ? ($row['first_name'] . ' ' . $row['last_name']) : 'Unknown';
                                                                                                        ...
                                                                                                        <td data-no-translate="true">
                                                                                                                <a href="" 
                                                                                                                        ...
                                                                                                                        data-sid="<?= $supplier['id'] ?>" data-no-translate="true"> <i class="fa fa-pencil"></i> <span data-translatable="true">Edit</span></a> | 
                                                                                                                <a href="" 
                                                                                                                        class="<?= in_array('supplier_delete', $user['permissions']) ? 'deleteSupplier' : 'accessDeniedErr' ?>" 
                                                                                                                        data-name="<?= htmlspecialchars($supplier['supplier_name']) ?>" data-sid="<?= $supplier['id'] ?>" data-no-translate="true"> <i class="fa fa-trash"></i> <span data-translatable="true">Delete</span></a>
                                                                                                        </td>
                                                                                                </tr>
                                                                                        <?php } ?>
                                                                                </tbody>
                                                                ...
                                                                $.ajax({
                                                                        ...
                                                                        success: function(data){
                                                                                message = data.success ? 
                                                                                        supplierName + ' successfully deleted!' : data.message || 'Error processing your request!';
